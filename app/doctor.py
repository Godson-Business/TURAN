...
def check_report_directory(root: Path) -> DoctorCheck:
    ...
    try:
        ...
        return DoctorCheck(name="Report folder", status="ok", summary="writable", details={"path": str(report_dir)})
    except OSError as exc:
        return DoctorCheck(name="Report folder", status="warn", summary="not writable", details={"error": exc.__class__.__name__})
