...
def remediation_note_path(finding: Finding, output_dir: str | Path = "reports/remediation") -> Path:
    note_dir = Path(output_dir)
    note_dir.mkdir(parents=True, exist_ok=True)
    return note_dir / f"{finding.id}.md"


def create_remediation_note_backup(finding: Finding, output_dir: str | Path = "reports/remediation") -> Path:
...
def write_remediation_note(
    finding: Finding,
    plan: FixPlan,
    output_dir: str | Path = "reports/remediation",
