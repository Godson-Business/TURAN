...
def applied_artifact_path(finding: Finding, output_dir: str | Path = "reports/generated") -> Path:
...
def _legacy_applied_artifact_path(finding: Finding) -> Path:
    return Path("reports/applied") / f"{finding.id}.conf"


def create_applied_artifact_backup(finding: Finding, output_dir: str | Path = "reports/generated") -> Path:
