...
from app.reports.console import render_console, render_fix_decisions, render_policy
...
def test_render_fix_decisions_shows_apply_plan() -> None:
    ...
    assert "reports/backups/f1.conf.bak" in text
    assert "reports/generated/f1.conf" in text
